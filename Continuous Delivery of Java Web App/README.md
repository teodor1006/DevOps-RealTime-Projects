...
- Image is then uploaded to ECR repository.
...
- We need to update port to 8080 in both Target group and Security group for TOMCAT.
...
- We need to update port to 8080 in both Target group and Security group for TOMCAT again.
...
- The application is then running on ECS.
