...
- [x] AWS Account
- [x] IDE of choice
- [x] GitHub account & Git

![](images/FlowDiagram.png)

### Step-1: Ansible Setup for AWS

For this project we will use `N.Virginia` region. Lets create an EC2 instance with below details:
```sh
AMI: Ubuntu 22.04
...
* `bastion_setup` file:
```sh
bastion_ami: ami-0beaa649c482330f7 # Amazon Linux-2 AMI-ID from us-east-1 region
region: us-east-1
