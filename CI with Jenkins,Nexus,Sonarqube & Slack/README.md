# Continuous Integration by using jenkins, Nexus, Sonarqube and Slack
...
![Flow](images/CI-Jenkins.jpg)

### Step-1: Create Keypair

 - We will need a key-pair while launching our EC2-Instances. Create a keypair and download the private key to your local system. Make sure to remember where you downloaded your key. We will need this key to SSH our servers.
...
sudo -i
sudo su - jenkins
git ls-remote -h -- git@github.com:devopshydclub/vprofile-project.git HEAD
```
...
- After that you should see the uploaded Artifact to the Nexus repository.
